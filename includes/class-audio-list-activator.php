...
class Audio_List_Activator {
	...
	public static function activate() {
      ...
      $sql = "CREATE TABLE IF NOT EXISTS $table_name (
        ...
        `content` text COLLATE $collate DEFAULT NULL COMMENT 'record text',
        `url` text COLLATE $collate DEFAULT NULL COMMENT 'sharing site',
        `link` text COLLATE $collate DEFAULT NULL COMMENT 'for picture',
