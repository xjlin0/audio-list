...
class Audio_List_Activator {
	...
	public static function activate() {
      ...
      $sql = "CREATE TABLE IF NOT EXISTS $table_name (
        ...
        `content` text COLLATE $collate DEFAULT NULL COMMENT 'for searching note',
        `url` text COLLATE $collate DEFAULT NULL COMMENT 'recording link',
        `link` text COLLATE $collate DEFAULT NULL COMMENT 'handout link',
        ...
        `location` varchar(255) COLLATE $collate DEFAULT NULL COMMENT 'where the sermon took place',
        `speaker` varchar(255) COLLATE $collate DEFAULT NULL,
        `topic` varchar(255) COLLATE $collate DEFAULT NULL,
        `section` varchar(255) COLLATE $collate DEFAULT NULL COMMENT 'verse referencing info for human eyes',
